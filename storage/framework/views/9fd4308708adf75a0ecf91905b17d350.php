...
<link href="<?php echo e(route('/')); ?>/assets/css/calendar.css" rel="stylesheet" />
<link href="<?php echo e(route('/')); ?>/assets/js/fullcalendar/packages/core/main.css" rel="stylesheet" />
<link href="<?php echo e(route('/')); ?>/assets/js/fullcalendar/packages/daygrid/main.css" rel="stylesheet" />
<link href="<?php echo e(route('/')); ?>/assets/js/fullcalendar/packages/timegrid/main.css" rel="stylesheet" />
<link href="<?php echo e(route('/')); ?>/assets/js/fullcalendar/packages/list/main.css" rel="stylesheet" />

<link rel="stylesheet" type="text/css" href="<?php echo e(route('/')); ?>/assets/css/daterangepicker.css" />
<link rel="stylesheet" type="text/css" href="<?php echo e(route('/')); ?>/assets/css/bootstrap-datepicker.css" />
...
<script src="<?php echo e(route('/')); ?>/assets/js/fullcalendar/packages/core/main.js"></script>
<script src="<?php echo e(route('/')); ?>/assets/js/fullcalendar/packages/interaction/main.js"></script>
<script src="<?php echo e(route('/')); ?>/assets/js/fullcalendar/packages/daygrid/main.js"></script>
<script src="<?php echo e(route('/')); ?>/assets/js/fullcalendar/packages/timegrid/main.js"></script>
<script src="<?php echo e(route('/')); ?>/assets/js/fullcalendar/packages/list/main.js"></script>
<script src="<?php echo e(route('/')); ?>/assets/js/fullcalendar/packages/resource-common/main.js"></script>
<script src="<?php echo e(route('/')); ?>/assets/js/fullcalendar/packages/resource-daygrid/main.js"></script>
<script src="<?php echo e(route('/')); ?>/assets/js/fullcalendar/packages/resource-timegrid/main.js"></script>

<script type="application/javascript" src="<?php echo e(route('/')); ?>/assets/js/moment.min.js"></script>
<script type="application/javascript" src="<?php echo e(route('/')); ?>/assets/js/daterangepicker.min.js"></script>
<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/js/bootstrap-datepicker.min.js"></script> -->
<script type="application/javascript" src="<?php echo e(route('/')); ?>/assets/js/bootstrap-datepicker.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.5/js/select2.full.js"> </script>
<script src="<?php echo e(route('/')); ?>/assets/js/calendar.js"></script>

<script>
    
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.light.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/webdev/Desktop/pc/client_data/XS_ryan/laravel-version/booknetic/resources/views/calender/index.blade.php ENDPATH**/ ?>